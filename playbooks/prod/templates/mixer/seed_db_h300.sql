...
(TRUE, 'RPM recalculation ratio', NULL, 'GEAR_RATIO', 'Possible values: <0, 1>. e.g. ratio is 0.5 -> 20 RPM on motor is 10 RPM on mixer', TRUE, (select id from module_device_type where model = 'H300-OD75S2G'));
...
(TRUE, 'RPM recalculation ratio', NULL, 'GEAR_RATIO', 'Possible values: <0, 1>. e.g. ratio is 0.5 -> 20 RPM on motor is 10 RPM on mixer', TRUE, (select id from device where name = 'VFD H300'));
